...
inline constexpr char P2P_MAGIC_DOMAIN[]{"ecash-elements-drivechain-p2p-v8"};
inline constexpr std::array<uint8_t, 4> P2P_MESSAGE_START{{0xd6, 0x01, 0x00, 0xf0}};
...
inline constexpr char DATA_DIR[]{"elements-v7"};
...
inline constexpr char BIP300301_ENFORCER_REVISION[]{
    "979e3598fc1543c2242f27b9c9bfca191ac554d5"};
...
inline constexpr uint32_t HISTORICAL_PROPOSAL_HEIGHT{2};
inline constexpr char HISTORICAL_PROPOSAL_BLOCK_HASH[]{
    "000001cb927226061b909c96d2684fa1b6677f160f730e9197f9a969c99fd4f0"};
inline constexpr uint32_t HISTORICAL_ACTIVATION_HEIGHT{8};
inline constexpr char HISTORICAL_ACTIVATION_BLOCK_HASH[]{
    "000000aeea2502319551402330b9d980fc56ef322777d982e5fca05079fcd143"};

inline constexpr uint32_t PARENT_CHECKPOINT_HEIGHT{102};
inline constexpr char PARENT_CHECKPOINT_HASH[]{
    "000002dc9bef2682f59c3607e9bf94588b52fc486191f0dbae3ca79d307523b8"};
inline constexpr char PARENT_CHECKPOINT_CHAINWORK[]{
    "000000000000000000000000000000000000000000000000000000001db4540c"};
inline constexpr char PARENT_CHECKPOINT_CTIP_TXID[]{
    "530ccb2f22d0af5a49097486ac502f7f1e50fb688dd3dcae46ee7297ba0c5799"};
inline constexpr uint32_t PARENT_CHECKPOINT_CTIP_VOUT{0};
inline constexpr int64_t PARENT_CHECKPOINT_CTIP_VALUE{100000};
...
inline constexpr std::array<uint8_t, 32> USDD_SP1_VERIFIER_SEMANTIC_IDENTITY{{
    0xbc, 0xc6, 0xda, 0x9b, 0x30, 0xaf, 0x25, 0x91,
    0xd9, 0x48, 0x53, 0x34, 0x93, 0x29, 0x1b, 0xd5,
    0x54, 0x3d, 0xa4, 0x48, 0xa3, 0x27, 0x0b, 0xa9,
    0x9b, 0x1d, 0xe0, 0xad, 0xe6, 0x4e, 0x17, 0x11,
}};
...
inline constexpr uint8_t USDD_SP1_ANNEX_STATEMENT_KIND{1};
...
// Frozen identities for the sole active SP1 proof-verification lane. The V7
// parent proposal, network identity, and genesis commit these together with
// generic controller-bound deployment semantics.
inline constexpr std::array<uint8_t, 32> USDD_SP1_CONTROLLER_CMR{{
...
inline constexpr std::array<uint8_t, 32> USDD_SP1_GUEST_PROGRAM_ID{{
    0x4f, 0x05, 0x11, 0x10, 0x3d, 0xab, 0x14, 0xb6,
    0x1d, 0xd5, 0xb1, 0x40, 0x3d, 0x07, 0x7b, 0xa1,
    0x0d, 0x28, 0xa8, 0x9a, 0x06, 0xdb, 0xb5, 0x4d,
    0x43, 0xe9, 0x68, 0x35, 0x42, 0xc1, 0xdf, 0x08,
}};
inline constexpr uint64_t USDD_SP1_GUEST_ELF_BYTES{1'353'056ULL};
inline constexpr std::array<uint8_t, 32> USDD_SP1_GUEST_ELF_SHA256{{
    0x14, 0xba, 0xde, 0xe9, 0x6a, 0xe7, 0x01, 0xe7,
    0x80, 0x60, 0x8e, 0x1e, 0x84, 0x71, 0x87, 0x76,
    0x8a, 0x0a, 0xc0, 0x71, 0x6b, 0x64, 0x16, 0x3e,
    0x44, 0x43, 0x24, 0x89, 0x76, 0x2b, 0x0a, 0xff,
}};
inline constexpr uint64_t USDD_SP1_CONTROLLER_PROGRAM_BYTES{6'155ULL};
inline constexpr std::array<uint8_t, 32> USDD_SP1_CONTROLLER_PROGRAM_SHA256{{
    0x63, 0x03, 0x10, 0x3d, 0x96, 0x8d, 0xb8, 0xda,
    0xda, 0x19, 0x09, 0xdd, 0x1d, 0x6f, 0xd6, 0xfb,
    0xd9, 0x08, 0x41, 0x48, 0x8f, 0x35, 0x86, 0x4e,
    0x84, 0x93, 0x82, 0xa3, 0x1b, 0x75, 0x80, 0x3a,
}};
inline constexpr std::array<uint8_t, 32> USDD_SP1_CONTROLLER_SOURCE_SHA256{{
    0x90, 0x0d, 0x52, 0x93, 0xdf, 0xed, 0xc8, 0x52,
    0xa7, 0xa5, 0x09, 0x8b, 0xc5, 0x2d, 0xfe, 0xdc,
    0xc4, 0xa4, 0xb7, 0x65, 0x50, 0x0e, 0x8e, 0xb5,
    0x8d, 0x6f, 0xa8, 0x12, 0x06, 0x20, 0x51, 0x0e,
}};
...
inline constexpr char PROTOCOL_MANIFEST_HASH[]{
    "619d1d6d2099af50dcef47e4b32f448edb783aeb605746b6b42f57bc7acb5ffd"};
inline constexpr char PROPOSAL_DESCRIPTION_HEX[]{
    "0008456c656d656e7473456c656d656e7473204472697665636861696e207634"
    "3b20636f6e74726f6c6c65722d626f756e64205350312076"
    "6572696669636174696f6e206163746976653b207265706c61792076343b2061"
    "6e6e65782076323b206f6e65204d362070657220706172656e7420626c6f636b"
    "3b207769746864726177616c20616363756d756c61746f722076313b20424950"
    "33303120636865636b706f696e742076313b2053696d706c6963697479206163"
    "746976653b20736c6f74203234fd5fcb7abc572fb4b6465760eb3a78db8e442"
    "fb3e447efdc50af99206d1d9d61968d2dbc91b5a844c821e526a53820b9e024f256"};
inline constexpr char PROPOSAL_HASH[]{
    "35229365279c88bb32709724322b5bffcecdf486f1e2e422d18f23078c88bd53"};
inline constexpr char IDENTITY_COMMITMENT[]{
    "f8ce8c98de534aae4fdb7117f2e279b114644010517e81fe6fb015fc2cbc54a4"};
...
inline constexpr char GENESIS_MERKLE_ROOT[]{
    "476fb87bfb43643406990ef515e1312eee2a6c72df508d3ebbb6f250db6ff2a7"};
inline constexpr char PEGGED_ASSET[]{
    "75bc00c53f72d2afc39158bdf60a7eb5a6728de2cddf51fa67d6de63da148e7e"};
