...
QString BitcoinUnits::description(Unit unit)
{
    ...
    switch (unit) {
    case Unit::BTC: return QString("Elements Bitcoin (BTC)");
    case Unit::mBTC: return QString("Milli-L-BTC (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-L-BTC (Lbits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Satoshi (Lsat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
