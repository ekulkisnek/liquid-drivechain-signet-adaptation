...
#ifdef ELEMENTS_FUNCTIONAL_TEST_ONLY
    constexpr bool require_production_chain{false};
#else
    constexpr bool require_production_chain{true};
#endif
    if (auto error = common::InitConfig(args, nullptr, require_production_chain)) {
