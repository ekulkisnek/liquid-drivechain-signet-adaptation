...
public:
    ...
    CBlockIndex* AddToBlockIndex(const CBlockHeader& block, CBlockIndex*& best_header,
                                 bool update_best_header = true) EXCLUSIVE_LOCKS_REQUIRED(cs_main);
    ...
    [[nodiscard]] bool IsBlockTreeDBInMemory() const { return m_opts.block_tree_db_params.memory_only; }
