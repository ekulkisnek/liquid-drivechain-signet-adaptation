...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-con_elementsmode", "Use Elements-like instead of Core-like witness encoding. This is required for CA/CT and defaults to 1 on custom Elements chains; it is forbidden on Bitcoin-compatible -chain=regtest.", ArgsManager::ALLOW_ANY, OptionsCategory::ELEMENTS);
