...
BOOST_AUTO_TEST_CASE(util_ReadConfigStream)
{
    ...
    test_args.SelectConfigNetwork(ChainTypeToString(ChainType::ELEMENTS));
    BOOST_CHECK(test_args.GetArg("-d", "xxx") == "e");
    BOOST_CHECK(test_args.GetArgs("-ccc").size() == 2);
    BOOST_CHECK(test_args.GetArg("-h", "xxx") == "0");
...
BOOST_AUTO_TEST_CASE(util_GetChainTypeString)
{
    ...
    BOOST_CHECK_EQUAL(test_args.GetChainTypeString(), "elements");
...
BOOST_FIXTURE_TEST_CASE(util_ArgsMerge, ArgsMergeTestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(out_sha_hex, "f4cb247cc5589eceb8071a1d1d7a3148b84701af7075c547f8223faea84206ac");
}
...
BOOST_FIXTURE_TEST_CASE(util_ChainMerge, ChainMergeTestingSetup)
{
    ...
    //
    //   <input> || <output>
    // Default remains elements; upstream now names -testnet4 in conflicts.
    BOOST_CHECK_EQUAL(out_sha_hex, "77edd519488e3cd5de1d47a2fbc0effdc4c967956badd976ad1947383e1b0cfc");
}
