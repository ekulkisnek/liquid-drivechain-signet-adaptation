...
struct BasicTestingSetup {
    // Restore global settings only after every other fixture member is destroyed.
    ...
    explicit BasicTestingSetup(const ChainType chainType = ChainType::MAIN, TestOpts opts = {}, const std::string& fedpegscript = "")
        : BasicTestingSetup{ChainTypeMetaFrom(chainType), opts, fedpegscript} {}
    explicit BasicTestingSetup(const ChainTypeMeta chainType, TestOpts = {}, const std::string& fedpegscript = "");
    ~BasicTestingSetup();
