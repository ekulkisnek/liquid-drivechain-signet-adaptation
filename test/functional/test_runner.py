...
BASE_SCRIPTS = [
    ...
    'feature_ecx_consensus_identity.py',
    'feature_ecx_withdrawal_guard.py --legacy-wallet',
    'feature_ecx_withdrawal_positive.py --legacy-wallet',
    'feature_standard_regtest_ecx_isolation.py',
