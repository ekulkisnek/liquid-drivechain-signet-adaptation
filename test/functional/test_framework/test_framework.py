...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def set_binary_paths(self):
        ...
        binaries = {
            "elements-functional-test-node": ("bitcoind", "BITCOIND"),
            "elements-functional-test-cli": ("bitcoincli", "BITCOINCLI"),
            "elements-functional-test-util": ("bitcoinutil", "BITCOINUTIL"),
            "elements-functional-test-wallet": ("bitcoinwallet", "BITCOINWALLET"),
        }
